      ...
      <section className='flex justify-center items-center w-full lg:gap-x-64 gap-x-24 flex-wrap'>
        <form className='flex flex-col justify-center items-start gap-12'>
          ...
          <div className='flex flex-col justify-center items-start gap-2 w-full'>
            ...
            <textarea name='message' id='message' rows={8} placeholder='Digite a mensagem' className='bg-[#D9D9D9] border-[#c8c8c8] border drop-shadow-md rounded-3xl xs:text-xl text-lg p-4 xs:w-full w-64 focus:outline-none focus:ring-1 focus:ring-slate-500 font-extralight xs:placeholder:text-lg placeholder:text-base placeholder:text-custom-gray'></textarea>
          </div>
